...
#pragma pack(1)
		...
		// New for SixtyFourBit - Used for Merchant_Purchase_Struct
		...
		*/
		...
		struct Spawn_Struct_Bitfields
		{
			...
			/*22*/	unsigned   linkdead : 1;		// 1 Toggles LD on or off after name. Correct for SixtyFourBit
		...
		*/
		...
		struct Spawn_Struct
		{
			...
			/*0000*/ //uint8  unknownSixtyFourBit3;
	   ...
	   */
		...
		*/
		struct WearChange_Struct {
			...
			/*018*/ uint32 unknown18; // New to SixtyFourBit
...
/*0046*/
		...
		*/
		...
		struct GuildCommand_Struct {
			...
			/*132*/	uint32 officer;
			/*136*/	uint32 unknown136;		// New in SixtyFourBit
			/*140*/
		};
		...
		*/
		...
		struct Illusion_Struct { // Was size: 336
			...
			/*256*/ uint8 unknown256[60];	// This and below are new to SixtyFourBit
		...
		*/
		...
		struct BookRequest_Struct {
			...
			/*0004*/	uint16 invslot;		// Is the slot, but the SixtyFourBit conversion causes it to fail.  Turned to 0 since it isnt required anyway.
		...
		*/
		struct Door_Struct
		{
			...
			/*0076*/ uint8	unknown0076[4]; // New for SixtyFourBit
		...
		*/
		...
		struct GuildMemberEntry_Struct {
			...
			uint16	zoneinstance;		// Seen 0s or -1 in SixtyFourBit
			uint16	zone_id;			// Seen 0s or -1 in SixtyFourBit
		...
		struct GuildDemoteStruct {
			/*000*/	char	name[64];
			/*064*/	char	target[64];
			/*128*/	uint32	rank;			// New in SixtyFourBit
			/*132*/
		};
		...
		struct TributeAbility_Struct {
			...
			/*128*/	uint32	unknown128;	// New to SixtyFourBit
			/*132*/	char	name[0];
		};
...
#if 0
		// Struct not used by Task System implentation but left for reference (current for SixtyFourBit)
		...
		*/
		...
		struct ItemQuaternaryBodyStruct
		{
			...
			uint8 unknown37a;	// New to SixtyFourBit - Probably variable length string
			uint8 unknown38;	// 0
			uint8 unknown39;	// 1
		};
